...
{
    public class Maske_AngebotsFormular : MyForm
    {
        ...
        {
            Formular formular = new Formular(Globals.FORMULAR_ANGEBOT);
        ...
        protected override void _InitializeComponent()
        {
            ...
            feld_Kopftext.PlaceholderText = " Kopftext auf dem Angebotsformular";
            ...
            feld_fusstext.PlaceholderText = " Fußtext auf dem Angebotsformular";
            ...
            feld_Zahlungszieltext.PlaceholderText = " Zahlungziel auf dem Angebotsformular";
