...
namespace MyControls
{
    ...
    public class DGVPrinter
    {
        ...
        /// </summary>
        public PrinterSettings PrintSettings => printDoc.PrinterSettings;
        ...
        public PrintDialogSettingsClass PrintDialogSettings => printDialogSettings;
        ...
        public Dictionary<string, DataGridViewCellStyle> ColumnHeaderStyles => columnheaderstyles;
        ...
        public Dictionary<string, float> ColumnWidths => publicwidthoverrides;
        ...
        private Dictionary<string, DataGridViewCellStyle> colstyles =
            new Dictionary<string, DataGridViewCellStyle>();
        public Dictionary<string, DataGridViewCellStyle> ColumnStyles => colstyles;
        ...
        private Dictionary<string, DataGridViewCellStyle> altrowcolstyles =
            new Dictionary<string, DataGridViewCellStyle>();
        public Dictionary<string, DataGridViewCellStyle> AlternatingRowColumnStyles => altrowcolstyles;
        ...
        //
        private bool selectionDialog = false;
        public bool SelectionDialog
        {
            get => selectionDialog;
            set => selectionDialog = value;
        }
        /// <summary>
        ...
        protected int GetColumnIndex(string colname)
        {
            ...
            if (i >= colstoprint.Count)
            {
                ...
                Log.Error("Unknown Column Name: " + colname);
            }
        ...
        public void PrintDataGridView(DataGridView dgv)
        {
            ...
            dataGridView = CloneGridView(dgv);
            if (selectionDialog)
            {
                AuswahlDialog dialog = new AuswahlDialog(dataGridView);
                DialogResult result = dialog.ShowDialog();
                if (result.Equals(DialogResult.OK))
                {
                    List<string> selectedColumns = dialog.getColumnSelected();
            ...
            Log.Information("PrintDataGridView process started");
            if (null == dataGridView) throw new Exception("Null Parameter passed to DGVPrinter.");
            if (!(typeof(DataGridView).IsInstanceOfType(dataGridView)))
        ...
        {
            Log.Information("PrintPreviewDataGridView process started");
        ...
        {
            Log.Information("DisplayPrintDialog process started");
        ...
        {
            Log.Information("PrintNoDisplay process started");
            if (null == dgv) throw new Exception("Null Parameter passed to DGVPrinter.");
        ...
        {
            Log.Information("PrintPreviewNoDisplay process started");
            if (null == dgv) throw new Exception("Null Parameter passed to DGVPrinter.");
            if (!(dgv is DataGridView))
                throw new Exception("Invalid Parameter passed to DGVPrinter.");
        ...
        {
            Log.Information("EmbeddedPrint process started");
        ...
        {
            Log.Information("EmbeddedPrintMultipageSetup process started");
            // verify we've been set up properly
            if ((null == dgv))
                throw new Exception("Null Parameter passed to DGVPrinter.");
        ...
        {
            Log.Information("BeginPrintEventHandler called. Printing started.");
        ...
        {
            Log.Information("PrintPageEventHandler called. Printing a page.");
        ...
        void SetupPrint()
        {
            ...
            */
            ...
            Log.Information(String.Format("PrintRange is {0}", printRange));
        ...
        private void SetupPrintRange()
        {
            ...
            Log.Information(String.Format("Grid Printout Range is {0} columns", colstoprint.Count));
            Log.Information(String.Format("Grid Printout Range is {0} rows", rowstoprint.Count));
        ...
        private bool PrintPage(Graphics g)
        {
            ...
            CurrentPage++;
            Log.Information(String.Format("Print Page processing page {0} -----------------------", CurrentPage));
            ...
            while (!printthispage)
            {
                Log.Information(String.Format("Print Page skipping page {0} part {1}", CurrentPage, currentpageset + 1));
                ...
                // log rows skipped
                Log.Information(String.Format("Print Page skipped rows {0} to {1}", firstrow, currentrow));
        ...
        private DataGridView CloneGridView(DataGridView dgv_org)
        {
            ...
            try
            {
                ...
                for (int i = 0; i < dgv_org.Rows.Count; i++)
                {
                    ...
                    foreach (DataGridViewCell cell in dgv_org.Rows[i].Cells)
                    {
                        ...
                        row.Cells[intColIndex].ValueType = cell.ValueType;
                        intColIndex++;
                    }
